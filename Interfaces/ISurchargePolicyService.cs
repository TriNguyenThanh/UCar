...
public interface ISurchargePolicyService
{
    ...
    /// </summary>
    Task<List<SurchargePolicy>> GetActiveSurchargePoliciesByTypeAsync(SurchargeType type, Guid? vehicleModelId = null);
    ...
    Task<decimal> CalculateOvertimeSurchargeAsync(Guid vehicleModelId, decimal overtimeHours);
    ...
    Task<decimal> CalculateExtraKilometerSurchargeAsync(Guid vehicleModelId, decimal extraKilometers);
    ...
    Task<decimal> CalculateHolidaySurchargeAsync(Guid vehicleModelId, decimal rentalAmount);

    /// <summary>
    /// Lấy phụ phí cố định theo loại
    /// </summary>
    /// <param name="type">Loại phụ phí (DeliveryService, CleaningFee, DriverService, etc.)</param>
    /// <param name="vehicleModelId">Model xe (optional)</param>
    Task<decimal> GetFixedSurchargeAmountAsync(SurchargeType type, Guid? vehicleModelId = null);
