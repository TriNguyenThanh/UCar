...
public interface IDepositPolicyService
{
    ...
    /// </summary>
    Task<PagedResult<DepositPolicy>> GetDepositPoliciesAsync(Guid? vehicleTypeId = null, bool? isActive = null, int page = 1, int pageSize = 20);
    ...
    /// <summary>
    /// Lấy chính sách đặt cọc đang active cho loại xe
    /// </summary>
